...
export const handleSummarize = async (inputText, selectedPrompt, summaryLength, api, setIsLoading, setSummary, setErrorMessage, setInputExpanded, setKeywords, setCodeSections, setInterviewQuestions) => {
    if (!inputText) return;
